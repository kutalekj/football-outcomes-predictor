        ...
        for player_id, occurrences in player_id_occurrences.items():
            ...
            if len(occurrences) > 1:
                ...
                for idx, duplicate_row in duplicates_to_remove:
                    # full_name = (
                    #     duplicate_row[full_name_index] if full_name_index is not None else "N/A"
                    # )
...
folder_path = r"C:\\Users\\kutalekj\\PycharmProjects\\sofifa-web-scraper\\output_optimized_phase7\\full"
