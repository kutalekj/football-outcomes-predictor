...
GET_XG_IF_MATCH_DATE_NEWER_THAN = datetime(2025, 11, 5)  # YYYY-MM-DD
...
M_LOAD_CSV = PROCESSED_DIR / "m_25-11-06_full.csv"
M_STORE_CSV = PROCESSED_DIR / "m_25-11-11_full.csv"
