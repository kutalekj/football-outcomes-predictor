...
AVG_HOME_TEAM_XG = 1.576
AVG_AWAY_TEAM_XG = 1.355
AVG_HOME_TEAM_PRE_MATCH_XG = 1.416
AVG_AWAY_TEAM_PRE_MATCH_XG = 1.224
...
TEAM_XG_NORM_COEFFICIENT = 3.1
TOTAL_XG_NORM_COEFFICIENT = 5.31
TEAM_PRE_MATCH_XG_NORM_COEFFICIENT = 2.85
TOTAL_PRE_MATCH_XG_NORM_COEFFICIENT = 5.37
